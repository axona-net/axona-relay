...
import { KERNEL_VERSION } from '/src/transport/handshake.js?v=4.38.1';
...
async function reconnectReporter(why) {
  ...
  try {
    const { createReporter } = await import('./axona-report.js?v=0.20.0');
...
async function copyAllData() {
  let bridge = null; try { bridge = (await import('./axona-report.js?v=0.20.0')).reportBridge; } catch (e) { diag('copy: reporter module unloadable: ' + (e.message || e)); }
  let health = null;
